...
<!--                        </datalist>-->
            ...
            <div class="mostrar-en-revista">
                ...
                <div class="opcion-mostar-en-revista">
                    <div class="si-mostar-en-revista">
                        ...
                        <input type="radio" onclick="javascript:yesnoCheck();" value="Si" name="mostrar_revista" id="yesCheck">
                    </div>
                    <div class="no-mostar-en-revista">
                        <label for="imagencrearanuncio">No<span></span></label>
                        <input type="radio" onclick="javascript:yesnoCheck();" value="No" name="mostrar_revista" id="noCheck"
                               checked>
                    </div>
                ...
                <div class="descripcion-revista">
                    <div id="ifYes" style="display:none">
                        ...
                        <div class="contador palabras">
                            <span><br>(Opcional)  Total palabras conteo</span> : <span id="display_count">0</span>
            ...
            <div class="imagen">
                ...
                <input type="file" name="nombreimagen[]" class="btn btn-default" id="gallery-photo-add" accept="image/*"
                       multiple required>
    ...
    <div id="consejos">
        ...
        <ul>
            ...
            <li>
                ...
                Indica todas las características de tu producto: si es usado, si es nuevo, en qué estado se encuentra,
