...
class GestorAnunciosModel{
	...
	public function guardarCaracteristicasClasificadosModel($datosModel, $tabla){
		...
		$stmt= $PDO->prepare("INSERT INTO $tabla (idcategoria, idsubcategoria, idmarca, idmodelo, fabricacion_vehiculo, tipo_modelo_vehiculo, tipo_combustible, tipo_transmision, condicion_vehiculo, kilometraje_vehiculo, tipo_operacion_inmueble, tipo_categoria_inmueble, nro_habitaciones, nro_servicios_higienicos, metros_cuandrados_inmuebles /* idclasificados*/) 
...
#		}
	...
	public function guardarClasificadosModel($datosModel, $tabla){
		...
		$PDO = Conexion::conectar();
		$stmt= $PDO->prepare("INSERT INTO $tabla (titulo, descripcion, tipo_moneda, precio, celular, descripcion_revista, precio_tipo, cod_revista, mostrar_en_revista, estado, /*idgaleria_imagen_clasificado,*/ iddetalle_caracteristica_clasificado, iddetalle_ubicacion_clasificado, idusuario) VALUES (:titulo, :descripcion, :tipo_moneda, :precio, :celular, :descripcion_revista, :precio_tipo, :cod_revista, :mostrar_en_revista, :estado, /* :idgaleria_imagen_clasificado,*/:iddetalle_caracteristica_clasificado, :iddetalle_ubicacion_clasificado, :idusuario)");
		...
		$stmt -> bindParam(":mostrar_en_revista", $datosModel["mostrar_en_revista"], PDO::PARAM_STR);
