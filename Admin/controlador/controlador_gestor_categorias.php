...
class GestorCategoriasController{
	...
	public function listarCategoriasController(){
		...
		$consulta_lista_categorias = GestorCategoriasModel::listarCategoriasModel("Tcategorias");

 		#$numberpaginas=10;
		$ruta = "vista/imagenes/anuncios/";

		if (!empty($consulta_lista_categorias)){

			foreach ($consulta_lista_categorias as $row => $item){
