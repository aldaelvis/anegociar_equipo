...
#		}
	...
	public function guardarClasificadosModel($datosModel, $tabla){
		...
		$PDO = Conexion::conectar();
		$stmt= $PDO->prepare("INSERT INTO $tabla (titulo, descripcion, tipo_moneda, precio, celular, cod_revista, estado, /*idgaleria_imagen_clasificado,*/ iddetalle_caracteristica_clasificado, iddetalle_ubicacion_clasificado, idusuario) VALUES (:titulo, :descripcion, :tipo_moneda, :precio, :celular, :cod_revista, :estado, /*:idgaleria_imagen_clasificado,*/ :iddetalle_caracteristica_clasificado, :iddetalle_ubicacion_clasificado, :idusuario)");
