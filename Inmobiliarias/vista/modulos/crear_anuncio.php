...
<div id="crear-anuncio">
	...
	<form method="post" enctype="multipart/form-data">
      ...
      <div class="categoria">
    		...
    		<input type="text" name="categoriacrearanuncio" class="categoriacrearanuncio"
    		  id="categoriacrearanuncio" value= "<?php echo $_SESSION['categorias-crear-anuncio'] ?>" required>
    	</div>
    	...
    	<div class="marca-modelo">
    		...
    		<div class="modelos">
    			...
    			<input list="modelocrearanuncio" name="modelo" class="modelo" placeholder="Debe elegir una marca" autocomplete="off" style="width:150px;">
          ...
          <select id="modelocrearanuncio" name="modelocrearanuncio" class="modelocrearanuncio">
    		...
    		<div class="año">
    			...
    			<input type="number" name="fabricacioncrearanuncio" class="fabricacioncrearanuncio" placeholder="Año" maxlength="4" min="1990" max="2018">
    		</div>
    	</div>
		</div>
      ...
      <div class="ubicaciondistrito">
		...
		<div class="mostrar-en-revista">
			<label for="descripcionrevistacrearanuncio">Deseas que tu anuncio aparezca en la revista<span></span></label>
			<div class="opcion-mostar-en-revista">
				<div class="si-mostar-en-revista">
					<label for="imagencrearanuncio">Si<span></span></label>
					<input type="radio" onclick="javascript:yesnoCheck();" value="Si" name="yesno" id="yesCheck">
				</div>
				<div class="no-mostar-en-revista">
					<label for="imagencrearanuncio">No<span></span></label>
					<input type="radio" onclick="javascript:yesnoCheck();" value="No" name="yesno" id="noCheck" checked>
				</div>
				<div class="imagen-mostar-en-revista">
					<img src="../vista/temas/img/pagina/clasificados/portada-principal.png" alt="Anegociar" />
				</div>
			</div>
			<script>
    		...
    		<div class="descripcion-revista">
              ...
              placeholder="Escriba una descripcion que saldra en la revista maximo 10 palabras (Opcional)."></textarea>
  					<div class="contador palabras">
  						<span><br>(Opcional)  Total palabras conteo</span> : <span id="display_count">0</span> palabras. Palabras izuierda : <span id="word_left">10</span>
  					</div>
			    </div>
		   </div>
		</div>
    ...
    <!-- 
    		<script type="text/javascript">
    			$(function(){$('#preciocrearanuncio').number( true, 2 );});
    		</script> -->

		<div class="precio">
			<label for="preciocrearanuncio">Precio<span></span></label>
			<input type="number" min="0" step="0.01" placeholder="Ingrese el precio de su anuncio" name="preciocrearanuncio"
...
<?php
$var = '<br />';
echo 'PLAN-WEB: '.$_SESSION['plan-crear-web-anuncio'];
echo $var;
echo 'PLAN-REVISTA: '.$_SESSION['plan-crear-revista-anuncio'];
echo $var;
echo 'CATEGORIA: '.$_SESSION['categorias-crear-anuncio'];
